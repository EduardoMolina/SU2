...
/*!
 * \class CUpwTAULD2_Flow
 * \brief Class for solving the TAU's Low-Dissipation and Low-Dispersion Scheme.
 * \ingroup ConvDiscr
 * \author E. Molina
 * \version 5.0.0 "Raven"
 */
class CUpwTAULD2_Flow : public CNumerics {
private:
  bool implicit;
  su2double *Diff_U;
  su2double *Velocity_i, *Velocity_j, *RoeVelocity;
  ...
  ProjVelocity, ProjVelocity_i, ProjVelocity_j;
  unsigned short iDim, iVar, jVar, kVar;
  su2double uLuR, rhoU_L, rhoU_R, PU_L, PU_R;
  su2double mL, mR, mF, pF;
  su2double aF, Vn_Mag, aux_slau, Mach_tilde, Chi, f_rho, BetaL, BetaR, Vn_MagL, Vn_MagR;
  unsigned short slau_low_diss;
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CUpwTAULD2_Flow(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
  
  /*!
   * \brief Destructor of the class.
   */
  ~CUpwTAULD2_Flow(void);
