...
enum ENUM_UPWIND {
  ...
  TAU_LD2 = 14                 /*!< \brief TAU's Low-Dissipation Low- Dispersion Skew-Symmetric numerical method. */
};
...
enum ENUM_LIMITER {
  ...
  VENKATAKRISHNAN_2NDLIM = 4	/*!< \brief Slope limiter using Venkatakrisnan + 2nd limiter method. */
};
