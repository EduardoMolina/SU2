...
void CConfig::SetConfig_Options(unsigned short val_iZone, unsigned short val_nZone) {
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  /*!\brief FORCE_INLET_PROFILE \n DESCRIPTION: Force the imposition of the inlet profile \n DEFAULT: NO \ingroup Config*/
  addBoolOption("FORCE_INLET_PROFILE", Force_Inlet_File, false);
  ...
  if (((val_software == SU2_DEF) || (val_software == SU2_DOT)) && (Design_Variable[0] != NO_DEFORMATION)) {
    ...
    if ((Kind_Solver == EULER) || (Kind_Solver == NAVIER_STOKES) || (Kind_Solver == RANS) ||
      ...
      if (Kind_ConvNumScheme_Flow == SPACE_UPWIND) {
        ...
        if (Kind_Upwind_Flow == SLAU2_KEP) cout << "Kinetic Energy Simple Low-Dissipation AUSM 2 solver for the flow inviscid terms."<< endl;
